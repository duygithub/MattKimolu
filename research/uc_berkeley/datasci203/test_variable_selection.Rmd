...
ordinal_mean <- floor(mean(df$event_ordinal))


pred_data <- expand.grid(
  event_ordinal = seq(min(df$event_ordinal),max(df$event_ordinal), length.out = 100),
...
# pred_data <- expand.grid(
#   event_ordinal = seq(ordinal_mean, ordinal_mean, length.out = 100),
#   stroke_count = seq(stroke_range[1], stroke_range[2], length.out = 100),
#   data_entry_type = unique(main_data_for_modeling2$data_entry_type)
# )
