...
The result of the F-test from ANOVA gave us a p-value of `r hypothesis_p_value` which is significant, so we reject null hypothesis. This result indicates that stroke count is meaningful for predicting swim time. 
