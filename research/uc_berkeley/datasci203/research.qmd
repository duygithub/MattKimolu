...
The result of the F-test from ANOVA gave us a p-value of `hypothesis_p_value` which is significant, so we reject null hypothesis. This result indicates that stroke count is meaningful for predicting swim time. 

### Result 2: Optimal Stroke count per data type and ordinal events


```{r optimal Stroke count}
...
type_seq <- unique(main_data_for_modeling2$data_entry_type)
