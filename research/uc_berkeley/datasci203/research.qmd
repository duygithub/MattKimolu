...
```{r Constant Variance Plot,  echo=FALSE, message=FALSE, warning=FALSE , fig.width=10, fig.height=8}
...
```{r, Model Validation, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=4.5}
#| echo: false
