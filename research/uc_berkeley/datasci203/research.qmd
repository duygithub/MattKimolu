...
#| fig-pos: H
#| fig-cap-location: top
#| label: plot_model_v1_no_outliers
#| message: false
#| warning: false
...
```{r, Outlier,Leverage,Influential plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r boxcox plot,  echo=FALSE, message=FALSE, warning=FALSE}
