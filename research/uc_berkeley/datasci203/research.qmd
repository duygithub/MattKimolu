...
# This is the latex code for model 4, But I am not able to render this one.
...
knitr::kable(model_compare_df_1 , digits = 3, caption = "Model Comparison")

# keep_last_n <- 6
# cut_row <- nrow(df) - keep_last_n  # line goes BEFORE row (cut_row + 1)
# 
# kbl(
#   df,
...
#   # HTML: black horizontal line before last 6 rows
#   row_spec(cut_row + 1, extra_css = "border-top: 2px solid black;") %>%
#   # PDF/LaTeX: horizontal rule before last 6 rows
#   row_spec(cut_row + 1, extra_latex_before = "\\midrule")
