...
The Residuals vs Fitted plot shows residuals scattered in a band of approximately uniform thickness across fitted values, with no funnel-shaped pattern.
...
```{r Constant Variance Plot,  echo=FALSE, message=FALSE, warning=FALSE , fig.width=10, fig.height=16}
...
```{r, Outlier,Leverage,Influential plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=5.7}
