...
```{r relationship bettween variables plot,  echo=FALSE, message=FALSE, warning=FALSE , fig.width=10, fig.height=6}
...
To check if there are any observations that affected the model v4, we examined outliers, leverage points, and influence points. 
