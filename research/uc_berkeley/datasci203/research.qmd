...
summary_data_entry_type_25_50L1 <- main_data_for_modeling %>%
...
summary_data_entry_type_50L2 <- main_data_for_modeling %>%
...
summary_data_entry_type_100IM <- main_data_for_modeling %>%
...
```{r setup_model_summary, echo=FALSE}
...
We achieved a smaller $R^2$ (`r model_v1_summary_data$r_squared`), but much lower adjusted $R^2$ (`r model_v1_summary_data$adjusted_r_squared`) and with estimators with higher $p$ values, indicating that this model suffers from overfitting.
...
Compared to @eq-regression_model_v1, we achieved an incrementally larger $R^2$ (`r model_v2_summary_data$r_squared`), but much lower adjusted $R^2$ (`r model_v2_summary_data$adjusted_r_squared`) and with estimators with higher $p$ values, indicating that this model suffers from overfitting.`