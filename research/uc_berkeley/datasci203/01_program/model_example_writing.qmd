...
5, Type intercept shifts $\gamma_k$: vertical shift of each type $𝑘$ relative to 25 when stroke = 0.
6, Type slope shifts $\delta_k$ : how the stroke slope differs for type $𝑘$ vs data_entry_type = 25.
